...
export function DomainVerify(props: DomainVerifyProps) {
                ...
                <div class="flex-1">
                  ...
                  <div class="mt-4 bg-amber-50 border border-amber-200 rounded-lg p-3">
                    <p class="text-sm text-amber-800">
                      <strong>Note:</strong> DNS changes can take 5-10 minutes
                      to propagate. Some providers may take up to 48 hours.
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  {user.domain_verification_status === "failed" && (
                    <div class="mt-4 bg-red-50 border border-red-200 rounded-lg p-3">
                      <p class="text-sm text-red-800">
                        ...
                        you've added the DNS TXT record correctly and wait a few
          ...
          <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
            <div class="flex items-start gap-3 mb-4">
              ...
              <div class="flex-1">
                ...
                <p class="text-gray-600 mb-4">
                  Your domain has been verified. Now add a CNAME record to point
                ...
                <div class="mt-4 bg-green-50 border border-green-200 rounded-lg p-3">
                  <p class="text-sm text-green-800">
                    <strong>Success!</strong> Once the CNAME record is added,
                    your profile will be accessible at{" "}
                    <strong safe>{user.custom_domain}</strong>
                  </p>
                </div>
              </div>
            </div>
