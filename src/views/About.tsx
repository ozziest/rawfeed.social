...
export function AboutPage(props: Props) {
  return (
    <LandingLayout {...props} title="About - Rawfeed">
      <>
        <div class="relative min-h-screen flex items-center justify-center bg-white dark:bg-gray-900">
          <div class="relative max-w-4xl mx-auto px-4 py-24 text-center">
            <h1 class="text-5xl sm:text-6xl md:text-7xl font-bold text-black dark:text-gray-100 mb-8 leading-tight">
              Reclaim Your Feed.
              <br />
              Reclaim Your Freedom.
            </h1>
            <p class="text-xl sm:text-2xl text-gray-700 dark:text-gray-300 max-w-2xl mx-auto mb-12 leading-relaxed">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="#learn-more"
                class="px-8 py-4 bg-white dark:bg-gray-900 text-black dark:text-gray-100 font-bold border-2 border-black dark:border-gray-400 hover:bg-black dark:hover:bg-gray-100 hover:text-white dark:hover:text-gray-900 transition-all text-lg"
              >
                Learn More
              </a>
            </div>
        ...
        <div class="border-y-2 border-black dark:border-gray-700 bg-white dark:bg-gray-900">
          <div class="max-w-4xl mx-auto px-4 py-16">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
              <div>
                <div class="text-6xl font-bold text-black dark:text-gray-100 mb-2">
                  100%
                </div>
                <div class="text-gray-600 dark:text-gray-400 font-medium uppercase tracking-wide text-sm">
                  Algorithm-Free
                </div>
              </div>
              <div>
        ...
        <div id="learn-more" class="bg-gray-50 dark:bg-gray-800 py-24">
          <div class="max-w-4xl mx-auto px-4">
            <div class="text-center mb-16">
              <p class="text-sm font-bold uppercase tracking-widest text-gray-500 dark:text-gray-400 mb-4">
                The Problem
              </p>
              <h2 class="text-4xl sm:text-5xl font-bold text-black dark:text-gray-100 mb-6 leading-tight">
            ...
            <div class="space-y-8">
              <div class="bg-white dark:bg-gray-700 border-2 border-black dark:border-gray-600 p-8">
                <h3 class="text-2xl font-bold text-black dark:text-gray-100 mb-3">
                  Broken Promises
                </h3>
        ...
        <div class="bg-white dark:bg-gray-900 py-24 border-y-2 border-black dark:border-gray-700">
          <div class="max-w-4xl mx-auto px-4">
            <div class="text-center mb-16">
              <p class="text-sm font-bold uppercase tracking-widest text-gray-500 dark:text-gray-400 mb-4">
                Our Solution
            ...
            <div class="space-y-6">
              <div class="border-l-4 border-black dark:border-gray-500 pl-6 py-4">
                <h3 class="text-2xl font-bold text-black dark:text-gray-100 mb-2">
        ...
        <div class="bg-white dark:bg-gray-900 py-24 border-y-2 border-black dark:border-gray-700">
          <div class="max-w-4xl mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 gap-8 mb-12">
              <div class="bg-white dark:bg-gray-800 border-2 border-black dark:border-gray-600 p-8">
                <h3 class="text-2xl font-bold text-black dark:text-gray-100 mb-6 pb-4 border-b-2 border-black dark:border-gray-600">
                  Social Network
                </h3>
            ...
            <div class="text-center bg-gray-50 dark:bg-gray-800 border-2 border-black dark:border-gray-600 p-8">
              <p class="text-sm font-bold uppercase tracking-widest text-gray-500 dark:text-gray-400 mb-4">
                Or Both
              </p>
              <h3 class="text-2xl font-bold text-black dark:text-gray-100 mb-4">
        ...
        <div class="relative bg-white dark:bg-gray-900 py-20 border-b-2 border-black dark:border-gray-700">
          <div class="max-w-4xl mx-auto px-4">
            <div class="bg-white dark:bg-gray-900 p-10 sm:p-16">
              <div class="text-center">
                <div class="inline-block px-5 py-3 bg-black text-white font-bold mb-6 text-sm uppercase tracking-wide">
                  Currently in Active Development
                </div>
                <h2 class="text-4xl sm:text-5xl font-extrabold text-gray-900 dark:text-gray-100 mb-6">
                  Building in the Open
                </h2>
                <p class="text-xl text-gray-700 dark:text-gray-300 max-w-2xl mx-auto mb-10 leading-relaxed">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    class="inline-flex items-center justify-center gap-3 px-8 py-4 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 font-bold border-2 border-black dark:border-gray-600 text-lg"
                  >
                    View Roadmap
                  </a>
                </div>
        ...
        <div class="relative bg-gray-50 dark:bg-gray-800 py-24 border-b-2 border-black dark:border-gray-700">
          <div class="max-w-4xl mx-auto px-4">
            <div class="text-center mb-16">
              <p class="text-sm font-bold uppercase tracking-widest text-gray-500 dark:text-gray-400 mb-4">
                Transparency
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
              <div class="bg-white dark:bg-gray-700 border-2 border-black dark:border-gray-600 p-8 text-center">
                <div class="text-5xl font-bold text-black dark:text-gray-100 mb-2">
                  $0
                </div>
                <div class="text-gray-600 dark:text-gray-400 font-medium uppercase tracking-wide text-sm">
                  Earned from Ads
            ...
            <div class="border-l-4 border-black dark:border-gray-500 pl-6 py-2 mb-12">
        ...
        <div class="relative bg-gray-50 dark:bg-gray-800 py-24">
          <div class="relative max-w-4xl mx-auto px-4">
            <div class="text-center mb-16">
              <h2 class="text-4xl sm:text-5xl md:text-6xl font-extrabold text-gray-900 dark:text-gray-100 mb-6">
                Join the Movement
              </h2>
            ...
            <div class="grid md:grid-cols-3 gap-6 mb-12">
              <div class="bg-white dark:bg-gray-700 border-2 border-black dark:border-gray-600 p-8">
                <h3 class="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-3 border-b-2 border-black dark:border-gray-600 pb-3">
                  For Developers
                </h3>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  class="inline-flex items-center text-gray-900 dark:text-gray-200 font-bold text-lg"
                >
                  → Contribute Code
                </a>
              </div>
            ...
            <div class="bg-white dark:bg-gray-700 border-2 border-black dark:border-gray-600 p-10 sm:p-12 max-w-3xl mx-auto">
              <p class="text-3xl font-extrabold text-gray-900 dark:text-gray-100 mb-6 text-center">
              ...
              <div class="text-center">
                ...
                <p class="text-gray-700 dark:text-gray-300 mt-6 text-base">
